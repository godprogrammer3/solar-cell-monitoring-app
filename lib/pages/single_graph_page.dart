...
class SingleGraphPage extends HookWidget {
  final ValueType type;
  const SingleGraphPage({
    Key? key,
    required this.type,
  }) : super(key: key);
            ...
            if (sensorValues.value.isEmpty)
              ...
              Expanded(
                child: SfCartesianChart(
                    ...
                    // Chart title
                    title: ChartTitle(text: 'กราฟ' + type.toNameString()),
                    ...
                    series: <ChartSeries>[
                      LineSeries<SensorValue, DateTime>(
                          ...
                          yValueMapper: (SensorValue value, _) =>
                              getSensorValueByValueType(value, type),
                          name: type.toNameString(),
                          // Enable data label
                          dataLabelSettings:
